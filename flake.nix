{
  ...
  outputs =
    ...
    }:
    {
      nixosModules = {
        neovim = {
          imports = [ ./nix/nixosModules.nix ];
        };
        default = self.nixosModules.neovim;
      };
      homeManagerModules = {
        neovim = {
          imports = [ ./nix/homeManagerModules.nix ];
        };
    ...
    // flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        nvim-treesitter = callPackage ./nix/pkgs/nvim-treesitter.nix {
          inherit nvimTreesitter treesitter-lock;
        };
      in
      {
